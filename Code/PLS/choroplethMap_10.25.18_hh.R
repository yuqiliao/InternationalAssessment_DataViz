...
wd <- "H:/ESSIN Pubs and Graphic Support/04_Project Working Files/Automating data figures/work with Howard/PLS"
...
for (figure_name in figure_list){
  state_data <- read.csv(paste0("./csv/", figure_name, ".csv"))
  ...
  zz2$geometry[[1]][1] <- st_polygon(list(matrix(c(c(2200000,2200000,2270000,2270000,2200000), c(-470000,-540000,-540000,-470000,-470000)), nrow = 5, ncol = 2)))
  z <- rbind(z,zz2)
  ...
  cairo_ps(paste0("./results/", figure_name, ".eps"), width = 13.84, height = 7.86)  ## PDF device
  print(gg)
  dev.off()
